# Magento 2 Age Verification Extension

[Magento 2 Age Verification](https://www.ulmod.com/age-verification-for-magento-2.html) is a Magento 2 extension that allows you prohibits underage visitors from viewing some page of your website.

With Magento 2 Age Verification, you can add a gate verification step at any page of your site, where visitors can verify their age before visiting the page. Visitors can verify their age via "date of birth", "checkbox", and "buttons" options.

<a href="https://www.ulmod.com/age-verification-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Create any number of age verifications
* Ability to  display age verifications at the home, product, category, cart, checkout, CMS pages, and any other pages
* Support predefined code insert to display age verification on any other pages and position
* Support date of birth, checkbox, and buttons layouts to display age verification
* Support privacy policy (GDPR) option, for GDPR compliance
* Ability to  restrict age verification display per store view and customer group
* Ability to  preview age verification in the admin panel
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/um-av-new-main.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/ageverif-place1-min.png">
